...
static FONT_DATA: [u8; FONT_WIDTH * FONT_HEIGHT * 96 / 8] = include!("../font_data_compressed.txt");
...
pub fn get_char_pixels(c: char) -> [[Color; PADDED_FONT_HEIGHT]; PADDED_FONT_WIDTH] {
